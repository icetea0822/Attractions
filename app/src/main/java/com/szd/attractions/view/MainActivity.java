package com.szd.attractions.view;
...
import com.szd.attractions.R;
import com.szd.attractions.SpeechUtils;
import com.szd.attractions.adapter.ItemAdapter;
import com.szd.attractions.utils.CheckPermissionsActivity;
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    ...
                    break;
                case 1:
                    adapter = new ItemAdapter(MainActivity.this, pois);
...
//                        mAnimation.setInterpolator(new LinearInterpolator());
    ...
    private void poiSearch() {
        ...
        poi = new PoiSearch(MainActivity.this, query);
